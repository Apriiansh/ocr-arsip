...
import { FileText, ArrowLeft, Edit, Download, Trash2 } from 'lucide-react';
        ...
        <div className="w-full h-full p-6">
            <div className="max-w-7xl mx-auto w-full h-full flex flex-col">
                <div className="card-neon rounded-xl overflow-hidden flex-grow flex flex-col animate-pulse">
                    ...
                    <div className="p-6 flex-grow overflow-y-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1">
                            <div className="sticky top-24">
                                ...
                                <div className="border border-border/40 rounded-lg overflow-hidden">
                                    ...
                                    <div className="w-full h-[70vh] bg-muted/40"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default function IsiArsipDetailPage() {
    ...
    const getBackUrl = () => {
        ...
        // bisa tambahkan else if (user?.role === "Sekretaris") return "/somewhere";
    ...
    const handleDelete = async () => {
        ...
        if (deleteError) {
            ...
            // Redirect back to the parent berkas detail page
            if (itemData.berkas_arsip_aktif?.id_arsip_aktif) {
                ...
                router.push('/arsip/daftar-aktif'); // Fallback
            }
        }
    };
                    ...
                    <div className="p-6 flex-grow overflow-y-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            <div className="bg-muted/30 p-5 rounded-lg border border-border/40">
                                <h3 className="text-lg font-semibold text-foreground mb-4">Informasi Item</h3>
                                <dl className="space-y-4 text-sm">
                                    {[
                                        { label: "Berkas Induk", value: `${itemData.berkas_arsip_aktif?.nomor_berkas} - ${itemData.berkas_arsip_aktif?.uraian_informasi}` },
                        ...
                        <div className="lg:col-span-1">
                            <div className="sticky top-24">
                                <h3 className="text-lg font-semibold text-foreground mb-4">Dokumen Digital</h3>
                                {itemData.file_url ? (
                                    <div className="border border-border rounded-lg overflow-hidden shadow-lg">
                                        <div className="bg-muted/50 p-2 flex justify-between items-center">
                                            <span className="text-sm font-medium text-muted-foreground truncate px-2">Dokumen</span>
                                            <a href={itemData.file_url} target="_blank" rel="noopener noreferrer" className="btn-icon" title="Unduh Dokumen">
                                                <Download size={18} />
                                            </a>
                                        </div>
                                        <div className="w-full h-[70vh] bg-muted/30">
                                            <iframe
                                    ...
                                    <div className="border-2 border-dashed border-border rounded-lg h-64 flex flex-col items-center justify-center text-muted-foreground">
                                        <FileText size={48} className="mb-2" />
                                        <p>Tidak ada dokumen digital.</p>
                                    </div>
                                )}
                            </div>
                        </div>
