...
import { FaFolder, FaCheckCircle, FaTasks, FaHourglassHalf, FaUserCircle, FaFileSignature, FaSync } from "react-icons/fa";
            ...
            <div className="max-w-screen-2xl mx-auto w-full h-full space-y-8" > {/* Added h-full to content container */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 card-neon p-6 rounded-xl">
                        ...
                        {arsipStatusBidangData.length > 0 ? (
                            <ResponsiveContainer width="100%" height={300}>
                                <BarChart data={arsipStatusBidangData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                    ...
                    <div className="card-neon p-6 rounded-xl">
                        ...
                        <div className="space-y-4">
                            {daftarSemuaArsipBidang.length > 0 ? (
                                daftarSemuaArsipBidang.map((arsip) => (
                                    <div
                        ...
                        {stats.totalArsip > 5 && (
                            ...
                            >
                                Lihat Semua Arsip ({stats.totalArsip})
                            </Link>
                        )}
                    </div>
                </div>
